...
# kinds that index the contents themselves are listed: for anything else -
# R_I51_8_IMM has a case there too, but it only range-checks and hands the
# write to the generic code - that generic code makes the same check, so
# deleting the port's would not be visible.
