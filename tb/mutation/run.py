...
# Every stage of the gate, in the order a CI run does them.  Cheap and
# discriminating first, so a killed mutant costs little.
STAGES = ['isa', 'branch', 'sim', 'defaultlink', 'commons', 'check']
